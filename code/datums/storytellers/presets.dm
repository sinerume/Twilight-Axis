...
/datum/storyteller/gamemode/extended
	...
	desc = "Без основных антагонистов, без легких антагонистов (вретчи/гноллы/ассасины), без дримволкеров. Карга присутствует."
...
/datum/storyteller/gamemode/guaranteed_antag
	...
	desc = "Гарантированный раундстартовый основной антагонист. До 9 вретчей. До 2 гноллов. Карга присутствует. Могут появиться дримволкеры."
...
/datum/storyteller/gamemode/guaranteed_antag/low_wretch
	...
	desc = "Гарантированный раундстартовый основной антагонист с более агрессивным масштабированием от онлайна. До 4 вретчей. До 1 гнолла. Карга присутствует."
	color_theme = "#7a1f1f"
	hard_mult = 2
	block_soft = FALSE
	allow_dreamwalker = FALSE
...
/datum/storyteller/gamemode/no_antag	// DEFAULT
	...
	desc = "Без основных антагонистов. Вретчи масштабируются обычно (от 5 до 12). До 3 гноллов. Карга присутствует. Дримволкер может появиться."
...
/datum/storyteller/gamemode/no_antag/small_wretch
	...
	desc = "Без основных антагонистов. Отродья фиксированы на 5 слотах. До 1 гнолла. Карга присутствует. Могут появиться дримволкеры."
	color_theme = "#1f6b67"
	allow_dreamwalker = FALSE
	preferred_gnoll_mode = GNOLL_SCALING_SINGLE	// max 1
	wretch_slot_cap = 5
